...
@DataJpaTest
@Testcontainers
@ContextConfiguration(initializers = BookRepositoryTest_1_Initializer_old_IT.DataSourceInitializer.class)
class BookRepositoryTest_1_Initializer_old_IT {

    @Container
    private static final PostgreSQLContainer<?> database = new PostgreSQLContainer<>("postgres:13.2-alpine");
